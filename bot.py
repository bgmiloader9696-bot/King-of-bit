...
ADMIN_ID = 7983241359  # YAHAN APNA TELEGRAM ID DALO
# -----------------------------------------------------------------
...
# Simple cooldown function (no decorator to avoid errors)
...
class TelegramBot:
    ...
    async def start(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        # Agar admin khud hai to directly approve
...
if __name__ == "__main__":
    if BOT_TOKEN == "8723966859:AAFH68kkE6ac8MjiBmQy8Qk21Hqt5Ovod_k" or ADMIN_ID == 8723966859:
        ...
        print("3. Copy the token (like: 8723966859:AAFH68kkE6ac8MjiBmQy8Qk21Hqt5Ovod_k)")
        print("\n🆔 How to get admin ID:")
        print("1. Go to @userinfobot on Telegram")
        print("2. Send /start")
        print("3. Copy your ID (like: 7983241359)")
        exit(1)
