...
# ------------------ CONFIGURATION ------------------
BOT_TOKEN = "8056773095:AAHUVyL0wi62sUmi9eK_raopUu6ANBudUZ0"      # @BotFather se lo
ADMIN_ID = 6548871396                   # Apna Telegram ID ( @userinfobot se pata karo)

# API endpoints (same as HTML version)
API_URLS = {
    '30S': 'https://draw.ar-lottery01.com/WinGo/WinGo_30S/GetHistoryIssuePage.json',
    '1M': 'https://draw.ar-lottery01.com/WinGo/WinGo_1M/GetHistoryIssuePage.json'
}

# ------------------ DATABASE (in-memory, for production use real DB) ------------------
pending_requests = {}      # pending approvals
approved_users = set()     # approved user IDs
user_data = {}             # settings, history, stats
running_tasks = {}         # prediction loops

# Cooldown to prevent double clicks
user_cooldown = {}

# ------------------ HELPER: PREVENT DOUBLE CLICK ------------------
...
# ------------------ PREDICTION ENGINE (same as HTML) ------------------
...
class TelegramBot:
    ...
    async def button_handler(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        if query.data == "start_prediction":
            ...
            # Fetch first prediction immediately
            try:
    ...
    async def prediction_loop(self, uid, mode, context):
        ...
        while user_data.get(uid,{}).get(mode, False):
            try:
                ...
                # after wait, check actual result
    ...
    async def check_actual_result(self, uid, mode, context):
        try:
            ...
            logging.error(f"Result check error: {e}")
