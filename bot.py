...
# ------------------ CONFIGURATION ------------------
BOT_TOKEN = os.getenv("BOT_TOKEN", "8723966859:AAFH68kkE6ac8MjiBmQy8Qk21Hqt5Ovod_k")
ADMIN_ID = int(os.getenv("ADMIN_ID", "7983241359"))
...
class TelegramBot:
    ...
    # START COMMAND - NO DECORATOR NEEDED HERE
