...
# ------------------ CONFIGURATION ------------------
BOT_TOKEN = os.getenv("8723966859:AAFeTtafFUz_ySZIWyHpYLQMycVOmw-Ij4U")
ADMIN_ID = int(os.getenv("7983241359")  # User provided admin ID
...
# ------------------ DECORATOR: PREVENT DOUBLE CLICK (FIXED) ------------------
